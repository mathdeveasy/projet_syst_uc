...
// Adresse I2C de l'ICM20948 :
// 0xD0 (7-bit: 0x68) si AD0 = GND
// 0xD2 (7-bit: 0x69) si AD0 = VCC (défaut carte Adafruit)
#define ICM20948_I2C_ADDR       (0x69 << 1)   // ← changer en 0x68<<1 si nécessaire

// Adresse I2C du magnéto AK09916 (accessible via I2C master interne de l'ICM)
#define AK09916_I2C_ADDR        (0x0C << 1)
